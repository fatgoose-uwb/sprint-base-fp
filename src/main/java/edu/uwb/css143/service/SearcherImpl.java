...
public class SearcherImpl implements Searcher {
    ...
    /*
    TODO (extra credit): Does your search beat the native search performance?
    TODO (extra credit): If yes, search the following in your local website, and then copy & paste the run times
     from the search page here as a proof in the format of search phrase, naive search time and your search time:
